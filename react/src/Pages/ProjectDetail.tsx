...
//     { title: "SELECTED FOR DEVELOPMENT", tasks: [{ id: "189", priority: "High", assignee: "ML MN" },{ id: "189", priority: "High", assignee: "ML MN" }] },
...
//           <Col span={6} key={stage.title}>
//             <Card
//               title={<Text strong>{stage.title}</Text>}
//               bordered={false}
//               style={{
//                 border: `1px solid ${["#1890ff", "#52c41a", "#faad14", "#eb2f96"][index]}`,
//                 borderRadius: "8px",
...
//                       <Text type="danger" style={{ fontWeight: 500 }}>{task.priority}</Text>
//                       <Avatar.Group maxCount={2}>
//                         {task.assignee.split(" ").map((assignee) => (
//                           <Avatar key={assignee} style={{ backgroundColor: "#f56a00", verticalAlign: "middle" }}>
//                             {assignee[0]}
//                           </Avatar>
//                         ))}
//                       </Avatar.Group>
