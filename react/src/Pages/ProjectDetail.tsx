...
import React, { useEffect, useState } from "react";
import { useParams } from "react-router-dom";
import { Card, Col, Row, Typography, Avatar, Divider, Modal } from "antd";
import {DragDropContext, Droppable, Draggable, DropResult, DroppableProvided, DraggableProvided } from "react-beautiful-dnd";
import { useDispatch, useSelector } from "react-redux";
import { DispatchType, RootState } from "../Redux/store";
import { GetProjectDetailByIdActionAsync, GetTaskDetailByIdActionAsync } from "../Redux/Reducers/ProjectReducer";
import { Assignee, TaskDetail, TaskStatus } from "../Models/ProjectModalType";
import { Stage, Task } from "../Models/TaskModalType";
import { GetTaskTypeActionAsync } from "../Redux/Reducers/TaskTypeReducer";
import { GetStatusActionAsync } from "../Redux/Reducers/StatusReducer";
  ...
  return (
    <div style={{ padding: 15 }}>
      <DragDropContext onDragEnd={onDragEnd}>
        ...
        <UpdateTask projectId={Number(id)} taskId={selectedTaskId} onClose={handleModalCancel} visible={isModalVisible}/>
      </DragDropContext>
    </div>
  );
};
